...
export class HttpClient<SecurityDataType = unknown> {
    public baseUrl: string =
        'https://virtserver.swaggerhub.com/mrnexeon/YouLearn/1.1';
 ...
 * @version 1.1
 * @baseUrl https://virtserver.swaggerhub.com/mrnexeon/YouLearn/1.1
 *
...
> extends HttpClient<SecurityDataType> {
    api = {
         ...
         */
        feedbackCreate: (
            feedback: { video_id: string; distractful: boolean },
            params: RequestParams = {},
        ) =>
